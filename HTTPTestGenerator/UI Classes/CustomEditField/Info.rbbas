...
Protected Module Info
	...
	#tag Note, Name = 2. Release Notes
		...
		• Added UseBackgroundColorForLine event, to change the background color of a particular line, see DemoWindow.SyntaxHilighter.UseBackgroundColorForLine
		...
		• Added GutterClicked event, useful in case you want to set bookmarks when the user clicks on the line numbers. See DemoWindow.SyntaxHilighter.GutterClicked for an example.
