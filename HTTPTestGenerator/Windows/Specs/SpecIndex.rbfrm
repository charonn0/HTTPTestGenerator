	...
	#tag Event
		Sub Change()
		  ...
		  Case Me.RowTag(Me.ListIndex) <> Nil And Me.RowTag(Me.ListIndex) IsA JSONItem
		    SpecViewer1.CurrentItem = Me.RowTag(Me.ListIndex)
		  End Select
		  
		  If Me.Cell(Me.ListIndex, 0) = "Delta-Base" Then
		    Dim i As Integer = 1
		    Do Until i <= 0
		      i = SpecViewer1.HilightText("th", i)
		      MsgBox("Next")
		    Loop
		  End If
		End Sub
